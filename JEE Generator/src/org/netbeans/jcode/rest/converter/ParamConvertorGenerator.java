...
public class ParamConvertorGenerator {
    ...
    private static final String PARAM_CONVERTER_CLASS = "CustomParamConverterProvider.java";
...
//        handler.progress(PARAM_CONVERTER_CLASS);
        FileUtil.expandTemplate(TEMPLATE, packageFolder, PARAM_CONVERTER_CLASS, params);
