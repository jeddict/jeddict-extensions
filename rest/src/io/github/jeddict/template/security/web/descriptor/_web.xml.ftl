    <security-constraint>
        <web-resource-collection>
            ...
            <url-pattern>/${applicationPath}/api/authenticate</url-pattern>
            <http-method>GET</http-method>
        </web-resource-collection>
        <web-resource-collection>
            <web-resource-name>${AccountController}.getAccount</web-resource-name>
            <url-pattern>/${applicationPath}/api/account</url-pattern>
            <http-method>GET</http-method>
        </web-resource-collection>
        <web-resource-collection>
        ...
        <web-resource-collection>
            ...
            <url-pattern>/${applicationPath}/api/account/change-password</url-pattern>
            <http-method>POST</http-method>
        </web-resource-collection>
        <web-resource-collection>
            <web-resource-name>${UserController}.getAllUsers</web-resource-name>
            <url-pattern>/${applicationPath}/api/users</url-pattern>
            <http-method>GET</http-method>
        </web-resource-collection>
        <web-resource-collection>
    ...
    <security-constraint>
        ...
        <web-resource-collection>
            ...
            <url-pattern>/${applicationPath}/api/users/authorities</url-pattern>
            <http-method>GET</http-method>
        </web-resource-collection>
        <web-resource-collection>
